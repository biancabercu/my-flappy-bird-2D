...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	modelMatrix = Transform2D::Translate(translateX, translateY)
					...
					* Transform2D::Translate(-50, -50);//translate cu -latura/2 
	//tot de mai sus se intampla pentru primul patrat , pentru ca mai apoi redefinim noi
	...
	//SATELITUL : 
	modelMatrix *= Transform2D::Translate(200, 50) //some offset(raza de orbita)
		* Transform2D::Scale(.25f, .25f)
		* Transform2D::Rotate(angularStep)
		* Transform2D::Translate(-50, -50);//pune centrul in origine
	//TODO create animations by multiplying current transform matrix with matrices from Transform 2D
	...
	modelMatrix *= Transform2D::Translate(250, 50) //some offset(raza de orbita)
		* Transform2D::Scale(.25f, .25f)
		* Transform2D::Translate(50,50)
		* Transform2D::Rotate(angularStep)
		* Transform2D::Translate(-50, -50);//pune centrul in origine
